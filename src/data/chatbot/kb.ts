...
const legacyServices: { id: string; questions: string[]; keywords?: string[]; answer: string; service: NonNullable<KbDoc["service"]> }[] = [
  ...
  { id: "hydro-jetting", questions: ["what is hydro jetting", "do you do hydro jetting", "hydrojet my drains", "do you offer rooter service", "do you have a rooter"], keywords: ["hydro", "jetting", "jet", "high pressure", "rooter", "roto"], answer: "Yes - we do both cabling (rooter service) and hydro-jetting. Hydro-jetting uses high-pressure water to scour grease, roots, and scale off the inside of a drain or sewer line, so it removes the buildup instead of just poking a hole through it the way a snake does. We often pair it with a camera inspection to confirm the line is clear.", service: "drains-clogs" },
